...
func lightStepSpanURL(span opentracing.Span) string {
	...
	return fmt.Sprintf("https://app.lightstep.com/%s/trace?span_guid=%x&at_micros=%d#span-%x", conf.Get().Core.LightstepProject, spanCtx.SpanID, t, spanCtx.SpanID)
}
